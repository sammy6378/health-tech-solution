...
// Handles all errors (NestJS and non-NestJS).

// Sends clean, consistent JSON error responses.

// Logs errors with timestamps and IPs to a log file using LogsService.
