...
interface EditMedicationDialogProps {
  med: TMedication | null
  isOpen: boolean
  onClose: () => void
  onSave: (updatedMed: TMedication,id: string) => void
}
...
export function EditMedicationDialog({
  ...
  // Initialize form data when med changes
  useEffect(() => {
    if (med) {
      setFormData(med)
      setSideEffects(med.side_effects?.join(', ') || '')
    }
  }, [med])
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    onSave(updatedMed, med?.medication_id || '')
  }
